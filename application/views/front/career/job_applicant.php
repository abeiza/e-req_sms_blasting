...
<html>
	<head>
		<title>e-Recruitment | Official Gloria Origita Cosmetics (APPLYING FORM)</title>
	</head>
	<style>
		body{
			font-family:calibri;
	...
	<body style="overflow-x: hidden;" onload="mylinkfunction('prs_fil','personal')">
		...
		<div class="container-fluit">
			<div class="layer-scroll">
				...
				<div style="">
					<ul style="float:left;width:100%;margin:0;padding:0;" class="tab">
						<li style="text-align:center;width:20%;float:left;">
							<a href="#" class="tablinks" onclick="" id="prs_fil" style="text-decoration:none;">
								<h3 style="margin-bottom:0px;margin-top:5px;">Data Pribadi</h3>
								<span>Step 1</span>
							</a>
						</li>
						<li style="text-align:center;width:20%;float:left;">
							<a href="#" class="tablinks" onclick="" id="fmy_fil" style="text-decoration:none;">
								<h3 style="margin-bottom:0px;margin-top:5px;">Data Keluarga</h3>
								<span>Step 2</span>
							</a>
						</li>
						<li style="text-align:center;width:20%;float:left;">
							<a href="#" class="tablinks" onclick="" id="edu_fil" style="text-decoration:none;">
								<h3 style="margin-bottom:0px;margin-top:5px;">Riwayat Pendidikan</h3>
								<span>Step 3</span>
							</a>
						</li>
						<li style="text-align:center;width:20%;float:left;">
							<a href="#" class="tablinks" onclick="" id="exp_fil" style="text-decoration:none;">
								<h3 style="margin-bottom:0px;margin-top:5px;">Riwayat Pekerjaan</h3>
								<span>Step 4</span>
							</a>
						</li>
						<li style="text-align:center;width:20%;float:left;">
							<a href="#" class="tablinks" onclick="" id="oth_fil" style="text-decoration:none;">
				...
				<?php 
					$attribut = array("style"=>"padding:20px 0px;float:left;");
					echo form_open_multipart('form/career/proses_upload/'.$this->uri->segment(4),$attribut);
				?>
				<div style="" id="personal" class="tabcontent">
					<h2>Data Pribadi</h2>
					<h4>#Step 1</h4>
					<hr/>
					...
					<div style="float:left;width:20%;">
						...
						<input type="file" style="margin-top:10px;float:left;width:90%;" name="pict" id="pict" value="<?php echo set_value('pict')?>"/>
					...
					<div style="float:left;width:80%;">
						<div class="group-text">
							<input type="hidden" name="career_id" id="career_id" value="<?php echo $id_career;?>"/>
						</div>
						<div class="group-text">
							...
							<input type="text" class="input-text" style="width:60%;" value="<?php echo $nama_career;?>" readonly/>
						</div>
						<div class="group-text">
						...
						<div class="group-text">
							...
							<select name="pribadi_gol_dar" id="pribadi_gol_dar" class="input-radio" style="width:8.5%;">
						...
						<a href="#" class="tablinks button" onclick="validationRequired()" style="padding: 15px;color: #fff;background-color: #8dc43f;border: 1px solid #8dc43f;cursor: pointer;float:right;">Next<i class="fa fa-angle-right" style="margin-left:10px;"></i></a>
					</div>
				</div>
				<div style="" id="family" class="tabcontent">
					<h2>Data Keluarga</h2>
					<h4>#Step 2</h4>
					<hr/>
					<div style="float:left;width:100%;">
						...
						<div class="group-text">
							...
							<label style="margin-left:5px;margin-top:5px;">Bersaudara</label>
						...
						<a href="#" class="tablinks button" onclick="mylinkfunction('edu_fil','education')" style="padding: 15px;color: #fff;background-color: #8dc43f;border: 1px solid #8dc43f;cursor: pointer;float:right;">Next<i class="fa fa-angle-right" style="margin-left:10px;"></i></a>
						<a href="#" class="tablinks button" onclick="mylinkfunction('prs_fil','personal')" style="padding: 15px;color: #fff;background-color: #8dc43f;border: 1px solid #8dc43f;cursor: pointer;float:right;margin-right:10px;"><i class="fa fa-angle-left" style="margin-right:10px;"></i>Previous</a>
					</div>
				</div>
				<div style="" id="education" class="tabcontent">
					...
					<div style="">
						...
						<a href="#" class="tablinks button" onclick="mylinkfunction('exp_fil','experience')" style="padding: 15px;color: #fff;background-color: #8dc43f;border: 1px solid #8dc43f;cursor: pointer;float:right;">Next<i class="fa fa-angle-right" style="margin-left:10px;"></i></a>
						<a href="#" class="tablinks button" onclick="mylinkfunction('fmy_fil','family')" style="padding: 15px;color: #fff;background-color: #8dc43f;border: 1px solid #8dc43f;cursor: pointer;float:right;margin-right:10px;"><i class="fa fa-angle-left" style="margin-right:10px;"></i>Previous</a>
					</div>
				</div>
				...
				<div style="" id="experience" class="tabcontent">
					...
					<div style="">
						...
						<a href="#" class="tablinks button" onclick="mylinkfunction('oth_fil','other')" style="padding: 15px;color: #fff;background-color: #8dc43f;border: 1px solid #8dc43f;cursor: pointer;float:right;">Next<i class="fa fa-angle-right" style="margin-left:10px;"></i></a>
						<a href="#" class="tablinks button" onclick="mylinkfunction('edu_fil','education')" style="padding: 15px;color: #fff;background-color: #8dc43f;border: 1px solid #8dc43f;cursor: pointer;float:right;margin-right:10px;"><i class="fa fa-angle-left" style="margin-right:10px;"></i>Previous</a>
					</div>
				</div>
				<div style="" id="other" class="tabcontent">
					...
					<div style="float:left;width:100%;">
						...
						<div class="group-text">	
							<input name="agree" id="agree" type="checkbox" class="input-text" style="width:10px;" onClick="validationAgreement('agree', 'submit');"/> Dengan ini saya telah memberikan informasi dengan sebenarnya.
						</div>
					</div>
						<button type="submit" id="submit" class="button" style="padding:16px;color: #fff;background-color: #8dc43f; opacity:0.7;border: 1px solid #8dc43f;cursor: pointer;float:right;" disabled>Send<i class="fa fa-send" style="margin-left:10px;"></i></button>
						<a href="#" class="tablinks button" onclick="mylinkfunction('exp_fil','experience')" style="padding:15px;color: #fff;background-color: #8dc43f;border: 1px solid #8dc43f;cursor: pointer;float:right;margin-right:10px;"><i class="fa fa-angle-left" style="margin-right:10px;"></i>Previous</a>
				</div>						
				<?php echo form_close();?>
				</div>
