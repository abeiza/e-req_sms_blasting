			<div style="width:82.5%;float:left;height:100%;background-color:#ffffff;overflow:auto;">
				<div style="width:100%;height:53px;border-bottom:1px solid #e7ecf1;padding-top:53px;display:flex;align-items:center;color:#666">
					<div style="width:50%;text-align:left;">
						<div style="padding:0px 20px;">Home <span class="fa fa-angle-right" style="margin:0px 5px;"></span> User Application <span class="fa fa-angle-right" style="margin:0px 5px;"></span> User (Test DISC)</div>
					</div>
				...
				<div style="float:left;width:100%;height:11.5%;background:#fff;color:#787878;">
					<div style="margin:0px 20px;width:auto;">	
						...
						<div style="margin-top:25px;float:left;margin-left:10px;"><a style="border-radius:5px;text-decoration:none;color:#fff;background-color:#8dc43f;margin:10px;padding:10px;" href="<?php echo base_url().'index.php/controller_user_application/generate_disc/'.$disc->resume_kode_lamaran;?>">Generate to PDF</a></div>
					</div>
				</div>
				<!-- End of header -->
				<!-- Separator -->
