			...
			$(function() {	
				$("#insert_item").click(function(){
					$.ajax({
						url:"<?php echo base_url();?>index.php/controller_message/update_data/",
						data:{
							id:$("#id").val(),
							name:$("#name").val(),
							number:$("#number").val()
			...
			<script>
				$(function() {	
					$(function(){
						$.ajax({
							url:"<?php echo base_url();?>index.php/controller_message/get_items_grid_id/<?php echo $this->uri->segment(3);?>",
							cache:false,
							type: "POST",
							dataType: 'json',
