			<div style="width:82.5%;float:left;height:100%;background-color:#ffffff;overflow:auto;">
				<div style="width:100%;height:53px;border-bottom:1px solid #e7ecf1;padding-top:53px;display:flex;align-items:center;color:#666">
					<div style="width:50%;text-align:left;">
						<div style="padding:0px 20px;">Home <span class="fa fa-angle-right" style="margin:0px 5px;"></span> User Application <span class="fa fa-angle-right" style="margin:0px 5px;"></span> User Application Resume</div>
					</div>
				...
				<div style="float:left;width:100%;height:11.5%;background:#fff;color:#787878;">
					<div style="margin:0px 20px;width:auto;">	
						...
						<div style="margin-top:25px;float:left;margin-left:10px;"><a style="border-radius:5px;text-decoration:none;color:#fff;background-color:#8dc43f;margin:10px;padding:10px;" href="<?php echo base_url().'index.php/controller_user_application/generate_resume/'.$detail->resume_kode_lamaran;?>">Generate to PDF</a></div>
					</div>
				</div>
				<!-- End of header -->
				<!-- Separator -->
					...
					<div style="float:left;margin:10px 2%;width:96%;background-color:#fff; border-radius:3px; border:1px solid #f1f1f1">
						<div style="width:90%;color:#787878;padding:5%;float:left;">
							<div style="text-align:center;width:100%;float:left;">
								<h3 style="color:#999;width:100%;padding-top:20px;">Form HRD 3 - DATA ISIAN PELAMAR</h3>
							...
							<div style="width:100%;float:left">
								...
								<div style="width:100%;float:left;">
									...
									<div style="width:1%;float:left;">:</div>
									<div style="width:78%;float:left;">
										<?php echo $detail->keluarga_darurat_nama==''?'-':$detail->keluarga_darurat_nama;?>
									</div>
									
									<div style="width:21%;float:left;">Hubungan</div>
									<div style="width:1%;float:left;">:</div>
									<div style="width:78%;float:left;">
										<?php echo $detail->keluarga_darurat_hubungan==''?'-':$detail->keluarga_darurat_hubungan;?>
									</div>
									
									<div style="width:21%;float:left;">Alamat & Telp</div>
									<div style="width:1%;float:left;">:</div>
									<div style="width:78%;float:left;">
										<?php echo $detail->keluarga_darurat_alamat==''?'-':$detail->keluarga_darurat_alamat;?>
									</div>
								</div>
							</div>
							<div style="width:100%;float:left">
							...
							<div style="width:100%;float:left">
								...
								<div style="width:100%;float:left;">
									...
									<div style="width:1%;float:left;">:</div>
									<div style="width:81%;float:left;"><?php echo $detail->pendidikan_judul_karya==''?'-':$detail->pendidikan_judul_karya;?></div>
									
									<div style="width:18%;float:left;">Tahun</div>
									<div style="width:1%;float:left;">:</div>
									<div style="width:81%;float:left;"><?php echo $detail->pendidikan_tahun_karya==''?'-':$detail->pendidikan_tahun_karya;?></div>
									
									<div style="width:18%;float:left;">Topik Bahasan</div>
									<div style="width:1%;float:left;">:</div>
									<div style="width:81%;float:left;"><?php echo $detail->pendidikan_topik_karya==''?'-':$detail->pendidikan_topik_karya;?></div>
								</div>
								<div style="width:100%;float:left;">
									<div style="width:100%;float:left;">
							...
							<div style="width:100%;float:left">
								...
								<div style="width:100%;float:left;">
									<table class="detail_resume" style="width:100%;">
										...
										<tbody>
											<tr>
												<td><?php echo $detail->pekerjaan_referensi_satu_nama==''?'-':$detail->pekerjaan_referensi_satu_nama;?></td>
												<td><?php echo $detail->pekerjaan_referensi_satu_jabatan==''?'-':$detail->pekerjaan_referensi_satu_jabatan;?></td>
												<td><?php echo $detail->pekerjaan_referensi_satu_alamat==''?'-':$detail->pekerjaan_referensi_satu_alamat;?></td>
												<td><?php echo $detail->pekerjaan_referensi_satu_telp==''?'-':$detail->pekerjaan_referensi_satu_telp;?></td>
											</tr>
											<tr>
												<td><?php echo $detail->pekerjaan_referensi_dua_nama==''?'-':$detail->pekerjaan_referensi_dua_nama;?></td>
												<td><?php echo $detail->pekerjaan_referensi_dua_jabatan==''?'-':$detail->pekerjaan_referensi_dua_jabatan;?></td>
												<td><?php echo $detail->pekerjaan_referensi_dua_alamat==''?'-':$detail->pekerjaan_referensi_dua_alamat;?></td>
												<td><?php echo $detail->pekerjaan_referensi_dua_telp==''?'-':$detail->pekerjaan_referensi_dua_telp;?></td>
											</tr>
											<tr>
												<td><?php echo $detail->pekerjaan_referensi_tiga_nama==''?'-':$detail->pekerjaan_referensi_tiga_nama;?></td>
												<td><?php echo $detail->pekerjaan_referensi_tiga_jabatan==''?'-':$detail->pekerjaan_referensi_tiga_jabatan;?></td>
												<td><?php echo $detail->pekerjaan_referensi_tiga_alamat==''?'-':$detail->pekerjaan_referensi_tiga_alamat;?></td>
												<td><?php echo $detail->pekerjaan_referensi_tiga_telp==''?'-':$detail->pekerjaan_referensi_tiga_telp;?></td>
											</tr>
										</tbody>
									</table>
								</div>
