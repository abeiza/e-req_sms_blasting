			...
			<script>
				function delete_data(e){
					$.confirm({
						...
						content: 'Are you sure delete this thread?',
						confirm: function(){
							var element = e.attr('id');
							$.ajax({
								url:"<?php echo base_url();?>index.php/controller_message/delete_thread/",
								cache:false,
								data:{
									id:element
								},
			...
			<div style="width:82.5%;float:left;height:100%;background-color:#ffffff;overflow:auto;">
				<div style="width:100%;height:53px;border-bottom:1px solid #e7ecf1;padding-top:53px;display:flex;align-items:center;color:#666">
					<div style="width:50%;text-align:left;">
						<div style="padding:0px 20px;">Home <span class="fa fa-angle-right" style="margin:0px 5px;"></span> Messages(Thread)</div>
					</div>
				...
				<div style="width:100%;float:left;color:#666;">
					...
					<h1>Inbox Thread Message</h1>
					<a href="<?php echo base_url().'index.php/controller_message/inbox';?>" style="text-decoration:none;padding:5px 10px;border:1px solid #f1f1f1;border-radius:3px;background-color:#55a747 !important;color:#fff;opacity:0.8;z-index:0;">List Version</a>
						<table style="margin-top:10px">
							...
							<?php if($inbox->num_rows() == 0){?>
								<tr>
									<td colspan="3">Data Thread is Not Available</td>
								</tr>
							<?php }else{ 
								...
								<tr>
									...
									<td><?php 
										...
										?></td>
									<td><?php echo $db->TextDecoded;?><br/><?php echo $db->ReceivingDateTime;?></td>
									...
									<td>
										<a id='<?php echo substr($db->Sender_Number,0,1)=='+'?substr($db->Sender_Number,1,50):$db->Sender_Number;?>' onclick='delete_data($(this))' style='color:#666;font-size:12px;padding:3px 7px;text-decoration:none;border-radius:15px;'><span class="fa fa-close" style="margin-right:3px;"></span><br/>Delete</a>
									</td>
								</tr>
							<?php 
								}
